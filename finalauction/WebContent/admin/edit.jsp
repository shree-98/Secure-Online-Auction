...
if(l1.dml("update tblproduct set pname='"+name+"',pno='"+pno+"',pmprice='"+pmprice+"',pstock='"+stock+"',pdate='"+date+"',ptime='"+time+"',pdesc='"+desc+"',pimage='"+image+"',cid='"+cid+"',uid='"+uid+"',count=0 where pid='"+id+"'"))
{
	out.println("Success");
}
else
