...
<td colspan=3><b>Do Actions</b></td>
...
{
	l1.rs=l1.stmt.executeQuery("select * from tblproduct where pdate > '"+date+"' and uid="+x);
}
if(request.getParameter("q")==null)
{
...
<td>
<a href="maxuser.jsp?id=<%out.println(l1.rs.getString("pid"));%>" class="w3-button w3-red">MAX USER</a>
</td>
<td>
<a href="deleteproduct.jsp?id=<%out.println(l1.rs.getString("pid"));%>" class="w3-button w3-red">REMOVE</a>

</td>
<td>
<a href="../updateproduct.jsp?upid=<%out.println(l1.rs.getString("pid"));%>" class="w3-button w3-red">EDIT</a>
